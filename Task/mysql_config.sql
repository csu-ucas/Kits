...
CREATE TABLE `tasks` (
  ...
  `compStorage` varchar(16) NOT NULL,
...
insert into `tasks`(`name`,`containerCopies`,`imageList`,`specifyNode`,`compType`,`compNum`,`compMemory`,`compStorage`) values('task1',1,'ubuntu',4,'GPU',1,'200m','200m');
UNLOCK TABLES;
